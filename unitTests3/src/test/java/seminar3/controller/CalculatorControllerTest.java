...
//    }
    ...
    public void getNumberInput(){
        ...
        Class <CalculatorController> controllerClass = CalculatorController.class;
        // Используя рефлексию получаем класс контроллера, как объект
        Method [] methods = controllerClass.getDeclaredMethods();
        // Получаем все методы класса, в том числе и private
...
//
//        // Проверяем, что было вызвано сообщение об ошибке с правильным сообщением
//        assertTrue(outContent.toString().contains("Деление на ноль запрещено!"));
//
